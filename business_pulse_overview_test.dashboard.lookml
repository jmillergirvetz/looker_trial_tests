- dashboard: business_pulse
  ...
  - title: Orders by Day and Category
    ...
    y_axes: [{label: Number of Orders, orientation: left, series: [{id: Accessories,
            name: Accessories, axisId: order_items.count}, {id: Blazers & Jackets,
            name: Blazers &amp; Jackets, axisId: order_items.count}, {id: Fashion
              Hoodies & Sweatshirts, name: Fashion Hoodies &amp; Sweatshirts, axisId: order_items.count},
          {id: Pants, name: Pants, axisId: order_items.count}, {id: Shorts, name: Shorts,
            axisId: order_items.count}, {id: Sweaters, name: Sweaters, axisId: order_items.count}],
  ...
  - title: Total Spend by Cohort
    ...
    y_axes: [{label: '', orientation: left, series: [{id: 2018-07, name: 2018-07,
            axisId: total_sale_price}, {id: 2018-06, name: 2018-06, axisId: total_sale_price},
          {id: 2018-05, name: 2018-05, axisId: total_sale_price}, {id: 2018-04, name: 2018-04,
            axisId: total_sale_price}, {id: 2018-03, name: 2018-03, axisId: total_sale_price},
          {id: 2018-02, name: 2018-02, axisId: total_sale_price}, {id: 2018-01, name: 2018-01,
            axisId: total_sale_price}, {id: 2017-12, name: 2017-12, axisId: total_sale_price},
          {id: 2017-11, name: 2017-11, axisId: total_sale_price}, {id: 2017-10, name: 2017-10,
            axisId: total_sale_price}, {id: 2017-09, name: 2017-09, axisId: total_sale_price}],
